...
int main()
{
    int t,cs=1,i,j,n,x,y,z,ans1,ans2;   ///AC
    bool f;
    ...
    while(t--){
        ...
        for(i=0;i<n;i++){
            sf3(x,y,z);
            graph[x].pb(make_pair(y,0));
            graph[y].pb(make_pair(x,z));
        }

        memset(visited,0,sizeof(visited));
        visited[1]=1;
        ans1=BFS(graph[1][0].first,graph[1][0].second);

        memset(visited,0,sizeof(visited));
        visited[1]=1;
        ans2=BFS(graph[1][1].first,graph[1][1].second);
