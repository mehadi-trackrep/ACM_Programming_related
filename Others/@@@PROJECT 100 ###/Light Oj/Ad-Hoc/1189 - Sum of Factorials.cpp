...
ll fact[25];    /// n er value maximum 20! er kacakaci hobe ...
ll check_point[25];
...
int main()  ///AC
{
    ...
    loop_tc(tc)
    {
        ...
        fd(i,20,0)
        {
            ...
            else check_point[i] = 0;
        }

        if(n) pf("Case %d: impossible\n",cas);      /// if n is the sum of factorials ..., then n = 0 hoye jabo ...otherwise n > 0 || n < 0 hobe ...
        else
        {
            int ck = 0;
            pf("Case %d: ",cas);
