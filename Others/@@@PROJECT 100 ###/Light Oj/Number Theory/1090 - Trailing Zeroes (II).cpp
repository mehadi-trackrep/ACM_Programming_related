...
ll count_two_or_five_in_factorial_part(ll n,ll div)
{
    ll total = 0;
    //cerr << "==>n: " << n << endl;
    while(n > 0)
...
ll count_two_or_five_in_power_part(int n,int div)
{
    ll total = 0;
    //cerr << "==>n: " << n << endl;
    while(n%div == 0)
...
int main()          ///AC
{
    ...
    loop_tc(tc)
    {
        ...
        /// for factorial part  , V.V.I.  duita part er 2 and 5 sum kore minimum ta ans hobe ... :)
        ll two,five;
        two = count_two_or_five_in_factorial_part(n,2);
        five = count_two_or_five_in_factorial_part(n,5);
        two -= count_two_or_five_in_factorial_part(n-r,2);
        two -= count_two_or_five_in_factorial_part(r,2);
        five -= count_two_or_five_in_factorial_part(n-r,5);
        five -= count_two_or_five_in_factorial_part(r,5);

        /// for power part:-
        int two1,five1;
        two1 = count_two_or_five_in_power_part(p,2);
        two1 *= q;
        five1 = count_two_or_five_in_power_part(p,5);
        five1 *= q;
