...
/// V.V.I:-
/// map <int,double> mp; etate MLE dibe ... karon 100000000 gula data SO,  eto boro size er array
/// not possible so, size ta reduce korci by 1000 -> 100000000/1000 = 100000 korci , jetay H[1] means
/// 1 to 1000 er summation , H[2] means 1 to 2000 er summation etc ...
...
int main(){ ///AC
    ...
    while( test-- ){
        scanf("%d", &n);
        double ans = H[n/1000];
        for(int i = (n/1000) * 1000 + 1 ; i <= n; i++) ans += 1.0/i;
        printf("Case %d: %.10lf\n", cs++, ans );
    }
    return 0;
}
