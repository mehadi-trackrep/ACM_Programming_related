...
(function () {
    ...
    ui.prompt = function (title, text, defaultInputText, callback) {
        ...
        var createDialog = function () {
            ...
            var modal_dialog = doc.createElement("div");
            modal_dialog.className = "modal-dialog";
            dialog.appendChild(modal_dialog);

           
            var modal_content = doc.createElement("div");
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            group4 = makeGroup(4);
            buttons.undo = makeButton("wmd-undo-button", "Undo - Ctrl+Z", "icon-mail-reply", null, group4);
            ...
            buttons.redo = makeButton("wmd-redo-button", redoTitle, "icon-mail-forward", null, group4);
