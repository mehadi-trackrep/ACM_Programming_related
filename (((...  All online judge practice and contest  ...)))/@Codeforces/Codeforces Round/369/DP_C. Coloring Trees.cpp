...
int n,m,k;
ll save[110][110][110];     ///AC
ll tree[110];
ll cost[110][110];
int mn;
bool ok;

ll dp(int pos , int prev_color , int group)     /// ekhane sate 3 ta ...
{
    ...
    if(save[pos][prev_color][group] != -1) return save[pos][prev_color][group];
    ...
    return save[pos][prev_color][group] = ret;
}
