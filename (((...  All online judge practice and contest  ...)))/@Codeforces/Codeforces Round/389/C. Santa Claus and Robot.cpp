...
int main()
{
	int n;
	char s[200005];
	while(scanf("%d ",&n) == 1) ///AC
    {
        gets(s+1);
        int ans=1,l=0,r=0,u=0,d=0;
        for(int i=1; s[i]!='\0'; i++)
        {
            if(s[i]=='L' and r) ans++,l=0,r=0,u=0,d=0;
            else if(s[i]=='R' and l) ans++,l=0,r=0,u=0,d=0;
            else if(s[i]=='U' and d) ans++,l=0,r=0,u=0,d=0;
            else if(s[i]=='D' and u) ans++,l=0,r=0,u=0,d=0;
