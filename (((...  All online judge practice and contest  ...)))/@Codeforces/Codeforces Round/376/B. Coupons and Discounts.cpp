    ...
    while(cin >> n)
    {
        ...
        for(int i=1; i<=n; i++)
        {
            if(ara[i]%2)
            {
                ...
                ara[i+1]--; /// ara[i] pizza gula ara[i]/2 gula discount diye nibo , baki ektar jonno ekta coupon use korbo , so (i+1)th day er pizza sonkha 1 kome gelo ...
                            /// karon, ekta coupon diya consecutive two days er jonno 2 ta pizza neoa possible ...
            }
        }
        pf("YES\n");
