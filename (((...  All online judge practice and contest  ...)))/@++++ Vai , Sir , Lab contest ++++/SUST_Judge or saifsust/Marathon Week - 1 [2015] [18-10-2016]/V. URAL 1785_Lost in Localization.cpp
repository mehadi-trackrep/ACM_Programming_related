...
int main()  ///AC
{
    ...
    if(n>=1 and n<=4) pf("few\n");
    else if(n>=5 and n<=9) pf("several\n");
    else if(n>=10 and n<=19) pf("pack\n");
    else if(n>=20 and n<=49) pf("lots\n");
    else if(n>=50 and n<=99) pf("horde\n");
    else if(n>=100 and n<=249) pf("throng\n");
    else if(n>=250 and n<=499) pf("swarm\n");
    else if(n>=500 and n<=999) pf("zounds\n");
    else pf("legion\n");
