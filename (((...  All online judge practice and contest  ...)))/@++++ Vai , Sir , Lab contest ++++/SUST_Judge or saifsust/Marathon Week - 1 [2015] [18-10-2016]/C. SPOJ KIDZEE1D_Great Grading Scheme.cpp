...
int main()  ///AC
{
    ...
    loop_tc(tc)
    {
        sf1(x);
        printf("Case %d: ",cas);
        if(x>=80 and x<=100) pf("A+\n");
        else if(x>=75 and x<=79) pf("A\n");
        else if(x>=70 and x<=74) pf("A-\n");
        else if(x>=65 and x<=69) pf("B+\n");
        else if(x>=60 and x<=64) pf("B\n");
        else if(x>=55 and x<=59) pf("B-\n");
        else if(x>=50 and x<=54) pf("C\n");
        else if(x>=45 and x<=49) pf("D\n");
        else if(x>=0 and x<=44) pf("F\n");
    }
	return 0;
}
