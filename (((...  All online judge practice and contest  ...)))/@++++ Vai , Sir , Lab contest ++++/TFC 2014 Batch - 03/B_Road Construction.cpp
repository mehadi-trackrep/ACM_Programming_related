...
int main()
{
	...
	loop_tc(tc)
	{
        ...
        {
            int cnt = 1;
            if(mp[make_pair(1,i)] == 1) continue;
            graph.push_back(make_pair(1,i));        /// let, 1 is the root
            cnt++;
            for(int j=2; j<=n; j++)
            {
                if(j != i && mp[make_pair(i,j)] == 0)
                {
        ...
        cerr << "\n................................................................\n\n";
        if(ck)
            for(int i=0; i<graph.size(); i++) cout << graph[i].first << " " << graph[i].second << endl;
