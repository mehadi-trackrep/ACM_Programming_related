...
int call(int i,int amount)  /// 0 th item theke suru kore  ...
{
    if(i >= total_coin)   /// All coins a ekbar kore jaoa hoye gece ... , V.V.I.: ekta item/coin a jaoar por amar option duita i) item/coin ti noya ii) or, na noya ...
    {
